function loadTour(){
  labelGuiElements();
    const tour = new Shepherd.Tour({
      ...
      let buttons = [{action() {return this.back();}, classes: 'shepherd-button-secondary',text: 'Back'},
      ...
      tour.addStep({
        ...
        (Animate doesn\'t look very good unless the music is extremely slow since it draws so slowly.)',
...
function labelGuiElements(){
  ...
  let idList = ['instrument','orbit','controls','octave','vis_type',
    ...
    'spiro_sign','custom_spiro_sign','draw_speed','midi','play']
